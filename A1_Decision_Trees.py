...
def DT(set1X_train, set1X_test, set1y_train, set1y_test,set2X_train, set2X_test, set2y_train, set2y_test):
    print("DT")
    ...
    # Fitting the classfier to the scaled dataset
    dt_classifier_scaled2 = DTpipe.fit(set2X_train, set2y_train)

    # Extracting the score
    print(dt_classifier_scaled2.score(set2X_train, set2y_train))
    # Testing accuracy on the test data
    dt_classifier_scaled1.score(set2X_test, set2y_test)
    print(dt_classifier_scaled2.score(set2X_test, set2y_test))
